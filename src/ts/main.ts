class Msg {
	...
	private box: string =
		...
		`;
	private readonly msgContainer: any;
	public config: any = {
		mode: 'light',
		type: 'success',
		msg: 'Success!! Please Wait....',
	};
	private readonly successIcon: string =
		`
		...
		`;
	private readonly errorIcon: string =
		`
	...
	constructor(msgContainer: string|Element) {
	...
	private showMsg(config: any): any{
		const messageBox: any = this.msgContainer;
